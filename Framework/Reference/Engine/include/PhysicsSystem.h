...
public:
	...
	inline PhysicsLayerManager* GetLayerManager() const { return m_physicsLayerManager; }
	...
	_declspec(property(get = GetLayerManager)) PhysicsLayerManager* layerManager;
...
private:
	...
	inline PxControllerManager* GetControllerManager() const override { return m_controllerManager; }
