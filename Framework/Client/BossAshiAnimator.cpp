...
void BossAshiAnimator::SetupNodes()
{
...

    {
        ...
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_B_ST, 1.0f));
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_L_ST, 2.0f));
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_R_ST, 3.0f));
...

    {
        ...
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_B_LP, 1.0f));
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_L_LP, 2.0f));
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_R_LP, 3.0f));
    ...
    {
        AnimatorNode* BH_WALK_F_ED = AnimatorSingleNode::Create(GetClip(TEXT("BH_WALK_F_ED")), LOOP);
        AnimatorNode* BH_WALK_B_ED = AnimatorSingleNode::Create(GetClip(TEXT("BH_WALK_B_ED")), LOOP);
        AnimatorNode* BH_WALK_L_ED = AnimatorSingleNode::Create(GetClip(TEXT("BH_WALK_L_ED")), LOOP);
        AnimatorNode* BH_WALK_R_ED = AnimatorSingleNode::Create(GetClip(TEXT("BH_WALK_R_ED")), LOOP);
        vector<Ref<AnimatorBlendNodeElement>> blendNodeElements;
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_F_ED, 0.0f));
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_B_ED, 1.0f));
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_L_ED, 2.0f));
        blendNodeElements.push_back(AnimatorBlendNodeElement::Create(BH_WALK_R_ED, 3.0f));
        BH_WALK_ED = AnimatorBlendNode::Create(TEXT("BH_WALK_ED"), blendNodeElements, WalkDirectionFProperty, LOOP);
