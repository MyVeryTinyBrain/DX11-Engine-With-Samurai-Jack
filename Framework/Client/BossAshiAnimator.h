...
public:
	...
	enum IntContext : int
	{
		...
		SWORDTRAIL_START = 0b10000,
		SWORDTRAIL_END = 0b100000,
	};
	...
	enum UIntContext : uint
	{
		...
		ATK_FAR = 0b1000000000,
		ATK_SHOOT_BEAM = 0b10000000000,
		ATK_GROUND_IMPACT = 0b100000000000,
		SWORD_DUST = 0b1000000000000,
		RIGHT_FOOT_DUST = 0b10000000000000,
		BODY_DUST = 0b100000000000000,
	};
